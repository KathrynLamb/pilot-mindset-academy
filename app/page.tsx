...
//                     onChange={(e) => setEmail(e.target.value)}
//                     placeholder="Enter your email"
//                     className="flex-1 px-6 py-4 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
//                     onKeyDown={(e) => e.key === 'Enter' && handleSubmit()}
//                   />
//                   <button
//                     onClick={handleSubmit}
//                     className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
//                   >
//                     Join Waitlist <ArrowRight className="w-5 h-5" />
//                   </button>
//                 </div>
...
//               </div>
//             ) : (
//               <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-8 max-w-2xl mx-auto mb-16">
//                 <CheckCircle className="w-16 h-16 text-green-400 mx-auto mb-4" />
//                 <h3 className="text-2xl font-bold text-green-400 mb-2">You're on the list! ✈️</h3>
//                 <p className="text-gray-300">Check your inbox—we'll send you exclusive pre-launch materials.</p>
//               </div>
...
//               <Image 
//                 src="/the_right_stuff.jpeg" 
//                 alt="Pilot Mindset Framework Diagram"
//                 width={1408}
//                 height={768}
...
//                 <div className="text-gray-400 mt-1">{stat.sublabel}</div>
//               </div>
//             ))}
//           </div>
//         </div>
      ...
      <div className="relative z-10">
        ...
        <footer className="border-t border-white/10 py-12 text-center">
          ...
          <p className="text-gray-400 text-sm">
            {/* 3. Hidden Click Implementation */}
            <span>© </span>
            <span 
              onClick={() => router.push('/admin/login')} 
              className="cursor-default hover:text-gray-300 transition-colors"
              title="" 
            >
              2025
            </span>
            <span> Think Like a Pilot. All rights reserved.</span>
          </p>
        </footer>
      </div>
    </div>
